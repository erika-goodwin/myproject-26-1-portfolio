...
export const projects: { link: string; projectItems: ProjectItem[] } = {
  link: "https://github.com/erika-goodwin/myproject-25-3-workout-record",
  projectItems: [
  {
    ...
    techs: ["React", "TypeScript", "LocalStorage", "TailwindCss"],
    links: {
      github: "https://github.com/erika-goodwin/myproject-25-3-workout-record",
...

  {
    ...
    image: "/images/projects/wod-tracker.png",
    description: [
